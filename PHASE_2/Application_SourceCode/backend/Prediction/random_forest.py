# Predict next outbreak for each disease in each country in current year using Random Forest Classifier
...
with open('random_forest_predictions.json', 'w') as fp:
    json.dump(predicted_outbreaks, fp)

print("Predicted results written to random_forest_predictions.json")